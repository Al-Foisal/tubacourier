...
Route::get('merchant/division_list', [ApiMerchant::class,"division_list"]);
// Route::get('merchant/district_list', [ApiMerchant::class,"district_list"]);
// Route::get('merchant/area_list', [ApiMerchant::class,"area_list"]);
// Route::get('merchant/union_list', [ApiMerchant::class,"union_list"]);

Route::get('merchant/get_district', [ApiMerchant::class,"get_district"]);
Route::get('merchant/get_area/{id}', [ApiMerchant::class,"get_area"]);
Route::get('merchant/get_union/{id}', [ApiMerchant::class,"get_union"]);


Route::get('/pages',[ApiPage::class,"pages"]);
Route::get('/pages/{slug}',[ApiPage::class,"pageDetails"]);
