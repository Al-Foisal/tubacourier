...
@section('content')
    ...
    <body>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body printSection" style="width: 45rem;float:left;height:100%">
              ...
              <h2>Tuba Courier</h2>
                    ...
                    <div class="merchant-note">
                        <p>Location:Tuba courier, Jessore</p>
                        <p>Hotline: 01310-271166 Email: info@tubacourier.com</p>
                        <p>www.tubacourier.com</p>
                    </div>
                </div>
