						  ...
						  <div class="modal-dialog modal-lg" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						          <thead>
						              <tr>
						                  <td>Excel File Column Instruction <a href="{{asset('frontEnd/images/example.xlsx')}}" download> (Sample file ) </a></td>
						              </tr>
						          </thead>
						 ...
						 <div class="fraud-search">
								...
								@csrf
									<div class="row">
									    ...
									    <div class="col-sm-6">
											<select type="text" id="district_get"  class="select2 form-control{{ $errors->has('division') ? ' is-invalid' : '' }}" value="{{ old('division') }}"  placeholder="Delivery Area" required="required">
									    ...
									    <div class="col-sm-6 mb-3" id="district_select">
											<select type="text" id="area_get"  class="select2 area_change form-control{{ $errors->has('district') ? ' is-invalid' : '' }}" value="{{ old('district') }}"  placeholder="Delivery Area" required="required">
									    ...
									    <div class="col-sm-6 mb-3" id="area_select">
											<select type="text" id="area_list"  class=" select2 form-control{{ $errors->has('areas') ? ' is-invalid' : '' }}" value="" placeholder="Delivery Area" required="required">
									    ...
									    <div class="col-sm-6 mb-3" id="union_select">
											<select type="text" id="union_list"  class="select2 form-control{{ $errors->has('reciveZone') ? ' is-invalid' : '' }}" value="{{ old('reciveZone') }}" name="reciveZone" placeholder="Delivery Area" required="required">
										...
										<div class="col-sm-6">
											<div class="form-group">
												 <input type="text" class=" form-control{{ $errors->has('sale_price') ? ' is-invalid' : '' }}" value="{{ old('sale_price') }}" name="sale_price" placeholder="Sale Price">
											 </div>
										</div>

										<div class="col-sm-6">
											<div class="form-group">
												 <input type="text" class=" form-control{{ $errors->has('invoice_id') ? ' is-invalid' : '' }}" value="{{ old('invoice_id') }}" name="invoice_id" placeholder="Invoice ID">
											 </div>
										</div>
...
formoption += "<option value='" + val.id + "'>" + val.zonename + "</option>";
