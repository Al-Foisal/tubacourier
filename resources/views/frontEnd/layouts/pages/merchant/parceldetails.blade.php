                        ...
                        <div class="col-sm-6">
                            <div class="track-right">
                                ...
                                <div class="item row">
                                    ...
                                    <div class="col-6">
                                        <h6>
                                            @if ($parceldetails->merchantpayStatus == 1)
                                                Processing
                                            @elseif($parceldetails->merchantpayStatus == 2)
                                                Paid
                                            @else
                                                #
                                            @endif
                                ...
                                <div class="item row">
                                    ...
                                    <div class="col-6">
                                        <h6>{{ $parceldetails->division->name ?? '' }}</h6>
                                    </div>
                                </div>
                                <div class="item row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <h6>{{ $parceldetails->district->name ?? '' }}</h6>
                                    </div>
                                </div>
                                <div class="item row">
                                    <div class="col-6">
                                ...
                                <div class="item row">
                                    ...
                                    <div class="col-6">
                                        <h6>{{ $parceldetails->union->zonename ?? '' }}</h6>
                                    </div>
                                </div>
                                <div class="item row">
                                    <div class="col-6">
