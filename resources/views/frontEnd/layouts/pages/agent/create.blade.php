                                ...
                                <div class="">
                                    ...
                                    <div style="width:650px;">
                                        <div class="card card-primary">
                                            ...
                                            <!-- /.card-header -->
                                            <!-- form start -->
                                            <form role="form" action="{{ url('agent/parcels-store') }}" method="POST"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            ...
                                                            value="{{ old('orderType') }}" name="orderType" required>
                                                            <option value="">Select...</option>
                                                            @foreach ($delivery as $deliveryopton)
                                                                <option value="{{ $deliveryopton->id }}">
                                                                    {{ $deliveryopton->title }}</option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}"
                                                            value="{{ old('address') }}" name="address" placeholder="Recipient Aderess"></textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="form-control {{ $errors->has('note') ? ' is-invalid' : '' }}"
                                                            value="{{ old('note') }}" name="note" placeholder="Note Optional"></textarea>
                                                        @if ($errors->has('note'))
                                                            <span class="invalid-feedback" role="alert">
