                                    ...
                                    <div class="form-group">
                                      <select name="pickupmanId" class="form-control select2" id="">
                                        <option value="">Select</option>
                                                         @foreach($deliverymen as $key=>$dman)
                         @php
                                $area =  App\Nearestzone::find($dman->area);
                         @endphp
                         @isset($area->zonename)
                         <option value="{{$dman->id}}">{{$dman->name}} ( {{$area->zonename}} )</option>
                         @endisset
                         @endforeach
                                      </select>
                                    </div>
                                ...
                                <div class="modal-body">
                                  <form action="{{url('editor/agent/asign')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select name="agentId" class="form-control select2" id="">
                                        <option value="">Select</option>
                          ...
                          <td>
                            <ul class="action_buttons cust-action-btn">
                              ...
                              @if(Auth::user()->role_id <= 2 )
                                 ...
                                 <li><a href="{{url('editor/parcel/edit/'.$value->id)}}" class="edit_icon"><i class="fa fa-edit"></i>Edit</a></li>
                                 
                                 <li><a href="{{url('editor/parcel/delete/'.$value->id)}}" onclick="return confirm('Are you delete this this?')" class="edit_icon"><i class="fa fa-del"></i>Delete</a></li>
