                            ...
                            <div class="card-body">
                                <form action="{{ url('editor/dliveryman-asign/bulk-option') }}" method="POST"
                                    ...
                                    <select class="bulkselect" name="asigntype">
                                        ...
                                        <option value="3">Print Selected Invoice</option>
                                    </select>
                                    <select class="bulkselect" name="parceltype">
                                ...
                                <td>
                                    @if ($value->pickupmanId)
                                        <button class="btn btn-primary" data-toggle="modal"
                                            data-target="#pickupmanModal{{ $value->id }}">{{ $value->deliverymen->name ?? '' }}</button>
                                    @else
                                        <button class="btn btn-primary" data-toggle="modal"
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('editor/pickupman/asign') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="merchant_phone"
                                                        value="{{ $value->merchant->phoneNumber ?? '' }}">
                                                    <div class="form-group">
                                                        <select name="pickupmanId" class="form-control select2"
                                                            id="">
                                                            <option value="">Select</option>
                                                            @foreach ($deliverymen as $key => $dman)
                                                                @isset($dman->nearestZone->zonename)
                                                                    <option value="{{ $dman->id }}">{{ $dman->name }} (
                                                                        {{ $dman->nearestZone->zonename }} )</option>
                                                                @endisset
                                                            @endforeach
                                                        </select>
                                                    </div>
                                ...
                                <td>
                                    @if ($value->deliverymanId)
                                        <button class="btn btn-info" data-toggle="modal"
                                            data-target="#asignModal{{ $value->id }}">{{ $value->deliverymen->name }}</button>
                                    @else
                                        <button class="btn btn-primary" data-toggle="modal"
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('editor/deliveryman/asign') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="merchant_phone"
                                                        value="{{ $value->merchant->phoneNumber ?? '' }}">
                                                    <div class="form-group">
                                                        <select name="deliverymanId" class="form-control select2"
                                                            id="">
                                                            <option value="">Select</option>
                                                            @foreach ($deliverymen as $key => $dman)
                                                                @isset($dman->nearestZone)
                                                                    <option value="{{ $dman->id }}">{{ $dman->name }} (
                                                                        {{ $dman->nearestZone->zonename }} )</option>
                                                                @endisset
                                                            @endforeach
                                ...
                                <td>
                                    @if ($value->agentman)
                                        <button class="btn btn-success" data-toggle="modal"
                                            data-target="#agentModal{{ $value->id }}">
                                            {{ $value->agentman->name }}</button>
                                    @else
                                        <button class="btn btn-primary" data-toggle="modal"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <table class="table table-bordered">
                                                                <tr>
                                                                    <td>Merchant Name</td>
                                                                    <td>{{ $value->merchant->firstName ?? '' }}
                                                                        {{ $value->merchant->lastName ?? '' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Merchant Phone</td>
                                                                    <td>{{ $value->merchant->phoneNumber ?? '' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Merchant Email</td>
                                                                    <td>{{ $value->merchant->emailAddress ?? '' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Company</td>
