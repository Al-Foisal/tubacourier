                            ...
                            <div class="card-body">
                                <div class="row">
                                    @foreach ($parceltypes as $key => $value)
                                        ...
                                        @endphp
                                        <div class="info-box-border-{{ $key }}" style="background: white;padding: 15px 0 0 10px;border-radius: 100px;width:30%;margin:1%;">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form class="form-group" action="{{ url('allparcel/search/') }}" method="post">
                                    @csrf
                                    <input type="text" placeholder="   Enter parcel" name="parcel"
                                        style="height : 40px;" class="mt-2">
